...
CREATE TABLE `hidden_messages` (
  ...
  `user_name` varchar(100) COLLATE utf8_swedish_ci DEFAULT NULL,
  `message` varchar(100) COLLATE utf8_swedish_ci DEFAULT NULL,
...
-- Dump completed on 2021-04-27 10:14:33
